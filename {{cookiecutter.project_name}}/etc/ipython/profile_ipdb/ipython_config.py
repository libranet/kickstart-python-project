...
ipython_cache_dir = pl.Path(os.getenv("IPYTHON_CACHE_DIR", "~/.cache/ipython-ipdb"))
# ipython_cache_dir = pl.Path(os.getenv("IPYTHON_CACHE_DIR", "~/.cache/ipython/profile_ipdb"))
...
c.TerminalInteractiveShell.debugger_history_file = str(ipython_cache_dir / "pdb-ipdb-history")
...
c.HistoryManager.hist_file = str(ipython_cache_dir / "history-ipdb.sqlite")
